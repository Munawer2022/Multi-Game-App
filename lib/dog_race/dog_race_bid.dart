...
class DogRaceBid extends StatefulWidget {
  const DogRaceBid({super.key});

  @override
  State<DogRaceBid> createState() => _DogRaceBidBidState();
}

class _DogRaceBidBidState extends State<DogRaceBid> {
  int hours = 1;
  int minutes = 60;
  int seconds = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: NestedScrollView(
            ...
            body: Consumer<DogRaceBidController>(
              ...
              return SingleChildScrollView(
                child: Column(children: [
                  ...
                  SizedBox(height: sized.size.height * 0.03),
                  Text('Select your lucky dog number',
...
Color spinnWheelColor = Colors.black;

class DogRaceBidController extends ChangeNotifier {
  int _value = 0;
